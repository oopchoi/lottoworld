...
//            }
            ...
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_3=" + n2 + " and num_4=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_3=" + n2 + " and num_5=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_3=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_4=" + n2 + " and num_5=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_4=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_2=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_3=" + n1 + " and num_4=" + n2 + " and num_5=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_3=" + n1 + " and num_4=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_3=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_1=" + n0 + " and num_4=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_2=" + n0 + " and num_3=" + n1 + " and num_4=" + n2 + " and num_5=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_2=" + n0 + " and num_3=" + n1 + " and num_4=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_2=" + n0 + " and num_3=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_2=" + n0 + " and num_4=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
            query = "delete from tbl_sub_combination where num_3=" + n0 + " and num_4=" + n1 + " and num_5=" + n2 + " and num_6=" + n3 + ";";
            deleteStmt = conn.prepareStatement(query);
            deleteStmt.execute();
